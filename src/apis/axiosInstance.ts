...
axiosInstance.defaults.baseURL = PRODUCTION ? 'https://api.nyangjanggo.com/api' : 'https://api.nyangjanggo.com/api';
axiosInstance.defaults.timeout = 30000;

export const authInstance = axios.create();

authInstance.defaults.validateStatus = (status) => status < 400;
authInstance.defaults.baseURL = PRODUCTION ? 'https://api.nyangjanggo.com/api' : 'https://api.nyangjanggo.com/api';
